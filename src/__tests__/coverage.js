...
test('emit milestone 1', () => {
  ...
  expect(emitSourceExpr('foo: (fn x x)'))
    .toStrictEqual('env = env.set(lang.sym("foo"), (() => { const __fnDefEnv = env; return (args) => { let fnEnv = __fnDefEnv; fnEnv = fnEnv.set(lang.sym("x"), args); return fnEnv.get(lang.sym("x")); }; })())')
  ...
  expect(nestedFn3).toContain('return (args) => { let fnEnv = __fnDefEnv;')
